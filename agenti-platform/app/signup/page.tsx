...
export default function SignUpPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a1628] via-[#0f2847] to-[#1e3a5f] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
          ...
          <form className="space-y-6">
            ...
            <div className="flex items-start">
              <input
                ...
                type="checkbox"
                required
                className="h-4 w-4 mt-1 rounded border-white/20 bg-white/10 text-[#3b82f6] focus:ring-[#00d4ff]"
              />
              <label htmlFor="terms" className="ml-2 block text-sm text-gray-300">
                I agree to the{" "}
                <Link href="#" className="text-[#00d4ff] hover:text-[#60a5fa]">
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link href="#" className="text-[#00d4ff] hover:text-[#60a5fa]">
        ...
        <p className="mt-6 text-center text-gray-400">
          ...
          <Link href="/signin" className="text-[#00d4ff] hover:text-[#60a5fa] font-semibold">
            Sign in
          </Link>
        </p>
      </div>
